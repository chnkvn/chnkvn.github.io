...
#+language: fr
#+options: author:nil
#+hugo_custom_front_matter: :author.name "Kevin" :author.email "blog@ckevin.fr"

* Cuisine
:properties:
:EXPORT_HUGO_SECTION: posts/cuisine
...
Bon appétit ! 
** DONE Pain de mie maison au levain :boulangerie:base:
...
** DONE Gaufres :boulangerie:base:
CLOSED: [2025-11-26 Wed 11:10]
:properties:
:EXPORT_FILE_NAME: gaufres
:end:
:LOGBOOK:
- State "DONE"       from "NEXT"       [2025-11-26 Wed 11:10]
:END:
...
#+NAME: Gaufres sans oeufs
#+CAPTION: Gaufres sans oeufs, faites au gaufrier
[[file:/images/cooking/gaufres.png][file:/images/cooking/gaufres.png]]
...
** DONE Viande de Kebab :plat:
CLOSED: [2025-11-26 Wed 15:36]
:properties:
:EXPORT_FILE_NAME: kebab-viande
:end:
:LOGBOOK:
- State "DONE"       from "TODO"       [2025-11-26 Wed 15:36]
:END:
...
#+CAPTION: Viande de kebab sur une tortilla
[[file:/images/cooking/viande_kebab_durum.png][file:/images/cooking/viande_kebab_durum.png]]
...
8. Avant la cuisson, couper de fines tranches de /lasagnes/ de viande. Elles ne doivent pas être trop fines sous peine d'être sèches à la cuisson. *Attention lors de la découpe, couper un produit congelé est dangereux*. 
#+NAME: Découpe de bloc de viande
#+CAPTION: Découpe de lamelles de viande congelée
[[file:/images/cooking/decoupe_bloc.png][file:/images/cooking/decoupe_bloc.png]]


9. [@9] Dans une poêle, chauffer la graisse d'agneau.
10. Faire revenir les tranches de viande coupées dans la poêle

#+NAME: Cuisson de la viande à feu fort dans la poêle
#+CAPTION: Découpe de lamelles de viande congelée, dans de la graisse d'agneau
[[file:/images/cooking/cuisson_viande_kebab.png][file:/images/cooking/cuisson_viande_kebab.png]]

11. [@11] Garnir votre kebab.

#+NAME: Repli du durum 
#+CAPTION: Repli du durum avant de passer à table
[[file:/images/cooking/repli_durum.png][file:/images/cooking/repli_durum.png]]

Bon appétit !
** DONE Baguettes au levain :boulangerie:base:
CLOSED: [2026-04-29 Wed 23:40] 
:properties:
:EXPORT_FILE_NAME:  baguette-levain
:end:
:LOGBOOK:
- State "DONE"       from "NEXT"       [2026-04-29 Wed 23:40]
:END:
...
Bon appétit !
** DONE Brownie sans gluten :patisserie:
CLOSED: [2026-04-29 Wed 23:37]
:Properties:
:EXPORT_FILE_NAME: brownie
:END:
:LOGBOOK:
- State "DONE"       from              [2026-04-29 Wed 23:37]
:END:
...
Bon appétit ! 
** DONE Pains pita maison :boulangerie:base:
CLOSED: [2026-06-11 Thu 23:50]
:properties:
:EXPORT_FILE_NAME: pains pita
:end:
:LOGBOOK:
- State "DONE"       from              [2026-06-11 Thu 23:50]
:END:
#+NAME: Pains pita cuits au four
#+CAPTION: Pains pita cuits au four
[[file:/images/cooking/pain_pita.png][file:/images/cooking/pain_pita.png]]
*** Infos
| Quantité    | Préparation | Repos    | Cuisson |
|-------------+-------------+----------+---------|
...
| Huile d'olive | 15mL    |               |
*** Instructions
1) Mélanger 70g de farine, l'eau, l'huile, la levure le sel et le sucre
2) Ajouter le restant de farine petit à petit et pétrir 10 minutes
3) Faire une boule avec la pâte, couvrir et laisser reposer 1 heure
4) Faire 6 boules avec la pâte, couvrir et laisser reposer 10 minutes
5) Préchauffer le four à 260°C avec une pierre à pizza dedans. Si vous n’avez pas de pierre à pizza, vous pourrez cuire les pitas dans une poêle qui n’est pas anti-adhésive à très haute température
6) Étaler chaque boule d’une épaisseur uniforme d’environ 5mm , fariner et laisser reposer quelques minutes sous un torchon humide
7) Cuire les pitas au moins 3 minutes, jusqu’à ce qu’elles gonflent et brunissent légèrement sur les côtés. Si vous cuisez les pitas à la poêle, n’hésitez pas à retourner la pita à mi-cuisson.
8) Une fois légèrement refroidi, vous pourrez couper votre pain en deux, et le garnir.

Les pains pita peuvent se congeler, toastez-les avant de les manger ! 

Bon appétit !
** DONE Pain cocotte  :boulangerie:base:
CLOSED: [2026-06-12 Fri 23:16]
:properties:
:EXPORT_FILE_NAME:  baguette-levain
:end:
:LOGBOOK:
- State "DONE"       from              [2026-06-12 Fri 23:16]
:END:

#+NAME: Pain cocotte tranché
#+CAPTION: Une recette simple qui ne demande que de la patience.
[[file:/images/cooking/pain_cocotte_tranche.png][file:/images/cooking/pain_cocotte_tranche.png]]
*** Infos

| Quantité    | Préparation | Repos    | Cuisson | 
|-------------+-------------+----------+---------|
| 1 pain rond |        0:05 | Minimum 12 heures |    0:50 |

- Nécessite idéalement une cocotte en fonte, ou au moins une cocotte en verre borosilicate. 
*** Ingrédients
| Ingrédient                    | Quantité | Remarques                                                                      |
|-------------------------------+----------+--------------------------------------------------------------------------------|
| Farine T65                    | 500g     | Je fais personnellement des traditions, j'utilise donc des farines Label Rouge |
| Eau                           | 300g     |                                                                                |
| Levure de boulanger | 1 sachet ou un demi-cube si fraîche  |                                                                                |
| Sel                           | 8.5g     |                                                                                |
- Taux d'hydratation : 60 %
- Il est possible d'utiliser du levain, c'est la version que je fais habituellement, et dans ce cas je ne mets pas de levure. Dans ce cas, la somme de la masse en farine du levain et de la farine doit être égale à 500g, tandis que la somme de la masse en eau du levain et de l'eau doit être égale à 300g. On recommande en général entre 15 et 30% du poids total de la farine en levain. 
  - Exemple :: En général, je pars sur 20% du poids total de la farine en levain, soit 500 * 20 /100 = 100g de levain. Mon levain étant composé d'autant d'eau que de farine, il y aura 50g d'eau et 50g de farine dans 100g de mon levain (taux d'hydratation de 100%). J'ajouterai donc 450g de farine (500-50) et 250g d'eau (300-50). 
  - Influence de la quantité de levain :: Plus il est faible, plus la fermentation prendra du temps et plus la mie aura tendance à être serrée. Plus il est fort, plus la pâte aura tendance à filer et plus votre pâte aura tendance à développer de l'acidité. 
*** Instructions
1) Après avoir rafraîchi le levain ou réactivé la levure, mélanger dans un récipient la farine, l'eau, le levain/la levure, le sel, jusqu'à obtention d'une pâte homogène.
#+NAME: Pâte après avoir mélangé tous les ingrédients
#+CAPTION: Une recette simple qui ne demande que de la patience.
[[file:/images/cooking/pain_cocotte_avant_pousse.png][file:/images/cooking/pain_cocotte_avant_pousse.png]]

2) [@2] Couvrir le saladier et l'oublier pendant au moins 12 heures, et jusqu'à 24 heures. La pâte devra avoir presque doublé de volume.
#+NAME: Pâte 20 heures plus tard, cuisine à 20°C
#+CAPTION: 20 heures après le mélange
[[file:/images/cooking/pain_cocotte_pousse.png][file:/images/cooking/pain_cocotte_pousse.png]]

3) [@3] Préchauffer le four et la cocotte à 230°C avec son couvercle. On préchauffe la cocotte pour éviter que le pain colle et faciliter son démoulage après cuisson.
4) Enfourner le pain pendant 50 minutes après l'avoir grigné : vous faites des entailles avec une lame aiguisée sur le dessus de la pâte pour favoriser sa pousse. 
5) Au bout de 50 minutes, vous pouvez stopper la cuisson, ou laisser le pain quelques minutes en plus dans le four sans couvercle pour le dorer
#+NAME: Pain en sortie de four
#+CAPTION: Après 50 minutes de four à 230°C
[[file:/images/cooking/pain_cocotte_cocotte.png][file:/images/cooking/pain_cocotte_cocotte.png]]
6) [@6] Attendre que le pain refroidisse et démouler, puis couper vos tranches de pain au fur et à mesure que vous souhaitez le manger.
7) Conserver le pain dans un torchon
#+NAME: Pain démoulé
#+CAPTION: L'heure de la dégustation
[[file:/images/cooking/pain_cocotte_expo.png][file:/images/cooking/pain_cocotte_expo.png]]
Bon appétit !
** TODO Cuisson basse-température
:properties:
:EXPORT_FILE_NAME: cuisson-basse-temperature
:end:
** NEXT Bûche pâtissière
:properties:
:EXPORT_FILE_NAME:  buche-patissiere
:end:
...
** TODO Éclairs au chocolat :patisserie:
Une version sans oeufs
#+NAME: Viande de kebab
#+CAPTION: Viande de kebab sur une tortilla
[[file:/images/cooking/viande_kebab_durum.png][file:/images/cooking/viande_kebab_durum.png]]
...
|-----------------+----------+----------------------------------------|
| Eau             | 125g     |                                        |
| Farine          | 50g      | Protéinée, je vise au minimum 11g/100g |
| Beurre          | 30g      |                                        |
| Fécule          | 27.5g    |                                        |
| Sucre           | 15g      |                                        |
| Sel             | 2g       |                                        |
| Lait            | 125g     |                                        |
| Levure chimique | 5g       | à peu près un demi-sachet              |
**** Crème Pâtissière
| Ingrédient | Quantité                              | Remarques                                                                                       |
|------------+---------------------------------------+-------------------------------------------------------------------------------------------------|
| Lait       | 125g                               |                                                                                                 |
| Fécule     | 10g                                  |                                                                                                 |
| Farine     | 8g                                 |                                                                                                 |
| Vanille    | quelques gouttes d'extrait de vanille |                                                                                                 |
| Sucre      | 35g                                   |                                                                                                 |
| chocolat   | 60g                                   | Dans le cas où vous souhaitez un parfum différent, remplacez le chocolat par ce que vous voulez |
**** Glaçage 
| Ingrédient | Quantité | Remarques |
|------------+----------+-----------|
| Beurre     | 15g      |  Idéalement non salé |
| Chocolat   | 25g     |           |

*** Instructions
**** Pâte à choux
1. Préchauffer le four à 180°C.
2. Mélanger l'eau, le beurre, le sel et le sucre dans une casserole sur le feu, et porter à ébullition.
3. Ajouter la farine en maintenant à feu doux
4. Mélanger la fécule dans le lait, puis ajouter le lait petit à petit dans la casserole en mélangeant, pour gélifier la pâte, 
5. Quand la pâte devient lisse et est gélifiée, couper le feu et ajouter la levure chimique, puis mélanger.
6. Pocher les éclairs puis enfourner 35 min. Ne pas hésiter à baisser la température si les éclairs brunissent trop vite.
**** Crème pâtissière 
1. Mélanger la fécule et le sucre dans un tiers du lait et faire chauffer le lait restant avec la vanille et le chocolat à feu moyen doux.

2. Mélanger le lait sucré dans le lait chaud et mélanger jusqu'à ébullition, pour gélifier la crème. 

3. Réserver au frais.

**** Glaçage
1. Dans le four chaud mais éteint, faire fondre le beurre et le chocolat.
2. En attendant, pocher les éclairs en faisant 3 ou 4 trous sur un côté de la pâte à choux
3. Homogénéiser le glaçage en le mélangeant
4. Tremper les éclairs dans le glaçage et lisser la surface glacée.
5. Réserver au frais. 
...
Bon appétit !
** TODO Substituts oeufs testés 
| Substitut         | Dosage | Exemples |
|-------------------+--------+----------|
| Yaourt            |        |          |
| Compote de pommes |        |          |
|                   |        |          |
** TODO Découpe d'un poulet entier
*** Infos
| Quantité | Préparation | Cuisson                             | Repos |
|----------+-------------+-------------------------------------+-------|
| 1 poulet |   0.02   | Dépend de la méthode de préparation |       |

*** Instructions
En règle générale, couper au niveau des lignes de graisses et au niveau des ligaments
1. Découper les cuisses 
2. Retourner le poulet et séparer les pilons du corps 
3. Retourner le poulet et couper la colonne vertébrale qui pourra servir pour faire un fond ou un bouillon en retirant la viande dessus avant.
4. Séparer les filets en deux
5. Séparer les hauts de cuisses des bas de cuisse.
6. Séparer les ligaments et tendons sur vos pièces avec une fourchette, en glissant la fourchette sous le tendon et en tirant sur ces derniers.
