...
J'aborderai chaque logiciel ou service numérique utilisé sur mes divers appareils, un pc portable sous linux et un autre pc sous Mac OS. Deux outils seront mentionnées si un même logiciel n'est pas compatible sur les deux plateformes.  
*** 
